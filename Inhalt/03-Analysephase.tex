...
\subsection{Anwendungsfälle} %todo: add use case diagramm
...
Dieses Diagramm befindet sich im \Anhang{app:UseCase}.


\subsection{Lastenheft/Fachkonzept} %todo: add lastenheft auszug
